...
export const Main: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: PAL.charcoal }}>
      ...
      {/* ── ONE quiet bed for the whole video, mixed low so the narrator is easily understood:
             "Explaining something" looped with its seams crossfaded, which suits a myth-buster and
             matches section 8's note that this package should feel the most confident in the series.
             EQ-carved around the narrator's band and mixed at 0.042 - about 27 dB under the voice.
             Ducked 3.5 dB across the CTA window and restored by 564.30s per section 9. The single
             largest swell of the video lands on S216 and nowhere earlier, per section 11. ── */}
